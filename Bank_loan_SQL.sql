...
--Total Funded Amount
SELECT SUM(loan_amount) AS Total_Funded_Amount FROM [Bank loan]
...
SELECT SUM(total_payment) AS Total_Amount_Collected FROM [Bank loan]
...
SELECT AVG(int_rate)*100 AS Avg_Int_Rate FROM [Bank loan]
 
--MTD Average Interest
SELECT AVG(int_rate)*100 AS MTD_Avg_Int_Rate FROM [Bank loan]
WHERE MONTH(issue_date) = 12
 
--PMTD Average Interest
SELECT AVG(int_rate)*100 AS PMTD_Avg_Int_Rate FROM [Bank loan]
WHERE MONTH(issue_date) = 11
